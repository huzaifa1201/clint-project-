...
// Corrected import to use compat version
...
const App: React.FC = () => {
  ...
  return (
    <AuthProvider>
      <WishlistProvider>
        <CartProvider>
          <div className="min-h-screen bg-zinc-950 flex flex-col text-white text-left">
            <Navbar />
              ...
              <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-2xl font-black italic tracking-tighter uppercase">NEONSTITCH</span>
                  </div>
                  ...
                  <div className="flex gap-4 pt-4">
                    {socialLinks.facebook && <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors">Facebook</a>}
                    {socialLinks.instagram && <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors">Instagram</a>}
                    {socialLinks.twitter && <a href={socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors">X / Twitter</a>}
                    {socialLinks.youtube && <a href={socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors">YouTube</a>}
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <form onSubmit={handleNewsletter} className="flex gap-2">
                    <input
                      ...
                      className="bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-xs flex-grow outline-none focus:border-green-500 transition-all text-white"
                    />
